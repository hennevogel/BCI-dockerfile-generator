...
LABEL org.opencontainers.image.source="https://github.com/SUSE/BCI-dockerfile-generator/tree/{{ image.os_version.deployment_branch_name }}/{{ image.package_name }}"
...
{%- endif %}
        ...
        <labels>
          ...
          <suse_label_helper:add_prefix prefix="{{ image.labelprefix }}">
            ...
            <label name="org.opencontainers.image.source" value="https://github.com/SUSE/BCI-dockerfile-generator/tree/{{ image.os_version.deployment_branch_name }}/{{ image.package_name }}"/>
